...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ObservationBase
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:component">
      <sch:assert test="count(f:extension[@url = 'https://larfuma.github.io/fhir-eyecare-ig/StructureDefinition/LensDuringVATestSpecification']) &lt;= 1">extension with URL = 'https://larfuma.github.io/fhir-eyecare-ig/StructureDefinition/LensDuringVATestSpecification': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://larfuma.github.io/fhir-eyecare-ig/StructureDefinition/LensDuringVATestSpecification']) &lt;= 1">extension with URL = 'https://larfuma.github.io/fhir-eyecare-ig/StructureDefinition/LensDuringVATestSpecification': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
